...
public class ClusterManager<T extends ClusterItem> implements
    ...
    public void onMapStatusChangeStart(MapStatus mapStatus) {
        if (mapStatusChangeListener != null) {
            mapStatusChangeListener.onClusterFindMapStatusChangeStart(mapStatus);
        }
    }
    ...
    public void onMapStatusChangeFinish(MapStatus mapStatus) {
        // 2017/10/31自己加的，本来这里什么也没有
        if (mapStatusChangeListener != null) {
            mapStatusChangeListener.onClusterFindMapStatusChangeFinish(mapStatus);
        }
    }
    ...
    public void setMapStatusChangeFinishListener(OnMapStatusChangeListener mapStatusChangeListener) {
        this.mapStatusChangeListener = mapStatusChangeListener;
    }

    public interface OnMapStatusChangeListener {
        void onClusterFindMapStatusChangeStart(MapStatus mapStatus);
        void onClusterFindMapStatusChangeFinish(MapStatus mapStatus);
    }
}
